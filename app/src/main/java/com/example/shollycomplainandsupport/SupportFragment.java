    ...
    public void onViewCreated(@Nullable View view,@NonNull Bundle savedInstanceState){
        ...
        itemClickListener=new RecyclerViewAdapter.ItemClickListener() {
            ...
            public void onItemClick(Complain complain, String type) {
                RecentMethods.setCurrentFragment(ViewingFragment.newInstance(SupportFragment.newInstance()),getActivity());
            }
        };
        recyclerView=view.findViewById(R.id.recyclerView);
        firebaseModel.getReference().child("AppData").child("support")
            ...
            public void onComplete(@NonNull Task<DataSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    RecyclerViewAdapter recyclerViewAdapter=new RecyclerViewAdapter(complainArrayList,itemClickListener,"support");
